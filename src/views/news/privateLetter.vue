<template>
  <f7-page>
    <f7-navbar>
      ...
      <f7-nav-title class="biaoti">
        <img src="../../assets/img_chat_modify_name.png" alt width="16px" height="16px">
        <p class="name-title">右友_106963b8</p>
      </f7-nav-title>
      <f7-nav-right>
        <f7-link icon="icon-bars" panel-open="right">
          ...
          >
          <img
            src="../../assets/ic_profile_space_interaction_more.png"
            alt
            width="30px"
            height="30px"
          >
